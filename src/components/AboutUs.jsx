  ...
  return (
    <>
      ...
      >
        ...
        >
          <h4 className="text-thickLightBlue font-semibold lg:mt-16">{name}</h4>
        ...
        <div>
          <img
            ...
            className={`rounded-t-3xl ${
              reverse
                ? " lg:rounded-none lg:rounded-tl-3xl lg:rounded-bl-3xl"
                : "lg:rounded-none lg:rounded-tr-3xl lg:rounded-br-3xl"
            }`}
          />
        </div>
      </div>
